public class Main {
    ...
    public static void query1(Studio[] studios)
    {
    ...
    public static void query2(Studio[] studios)
    {
        ...
        for(Studio s: studios)
        {
            for(Film f:s.getFilme())
            {
                ...
                {
                    if(a.getNume().compareTo("actor cu 2 oscaruri")==0)
                    {
                        System.out.println(s.getNume());
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        query1(studioDatabase);
        query2(studioDatabase);
